...
|___/_|_|\___|_|\_(_)/ |___/
                   |__/    jssor_slider1.$On( $JssorSlider$.$EVT_STATE_CHANGE , function(slideIndex, progress, progressBegin, idleBegin, idleEnd, progressEnd){
...
$(document).ready(function(){
    ...
    $(".slick-slide").mouseover(function(){
        console.log('am here');
        $(".slick-center").addClass('effect');
    });
    $(".slick-slide").mouseout(function(){
        console.log('am here');
        $(".slick-center").removeClass('effect');
    });
  });